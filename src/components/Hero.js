      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "span",
              { className: "block bg-gradient-to-r from-white via-purple-200 to-teal-200 bg-clip-text text-transparent" },
              "Codezyra —"
            ),
            React.createElement(
              "span",
        ...
        React.createElement(
          ...
          React.createElement(
            Button,
            { className: "group relative overflow-hidden bg-gradient-to-r from-purple-600 to-teal-500 hover:from-purple-700 hover:to-teal-600 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-purple-500/25" },
            React.createElement(
              motion.span,
              {
          ...
          React.createElement(
            Button,
            { variant: "outline", className: "group flex items-center border-2 border-purple-500/50 text-purple-400 hover:bg-purple-500/10 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:border-purple-400" },
          ...
          stats.map((stat, index) => {
            ...
            return React.createElement(
              ...
              React.createElement(Icon, {
                className:
                  "w-8 h-8 mx-auto mb-3 " + (currentStatIndex === index ? "text-purple-400" : "text-gray-400")
              }),
              React.createElement(
                "div",
                {
