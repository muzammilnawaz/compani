              ...
              {values.map((value, index) => {
                ...
                return (
                  <motion.div key={index} variants={itemVariants}>
                    <Card className="h-full bg-slate-800/50 border-slate-700 hover:border-purple-500/50 transition-all duration-300 text-center group">
                      <CardHeader>
                        <div className={`w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br ${
                          value.color === 'purple' ? 'from-purple-500/20 to-purple-600/20' : 'from-teal-500/20 to-teal-600/20'
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {team.map((member, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <Card className="bg-slate-800/50 border-slate-700 hover:border-purple-500/50 transition-all duration-300 overflow-hidden">
                    <div className="relative">
                      <ImageWithFallback
                        src={member.image}
                        alt={member.name}
              ...
              return (
                ...
                >
                  <div className={`w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br ${
                    stat.color === 'purple' ? 'from-purple-500/20 to-purple-600/20' : 'from-teal-500/20 to-teal-600/20'
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <motion.div
            ...
            animate={isInView ? "visible" : "hidden"}
          >
            <h3 className="text-3xl font-bold text-white mb-6">Why Choose Codezyra?</h3>
            <p className="text-gray-300 mb-6 leading-relaxed">
          ...
          {values.map((value, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -5 }}
              >
                <Card className="h-full bg-slate-800/50 backdrop-blur-sm border-slate-700 hover:border-purple-500/50 transition-all duration-300 text-center group cursor-pointer">
                  <CardHeader>
