...
export default function Services({ detailed = false }) {
  ...
  const services = [
    ...
    },
    {
      ...
      longDesc:
        "Drive immediate, qualified traffic to your website with our data-driven PPC campaigns across Google Ads, Facebook, LinkedIn, and other platforms. We optimize for maximum ROI and conversion rates.",
      features: [
    ...
    },
    {
      ...
      longDesc:
        "Create compelling social media strategies that engage your audience, build brand loyalty, and drive conversions across all major social platforms including Facebook, Instagram, Twitter, LinkedIn, and TikTok.",
      features: [
    ...
    },
    {
      ...
      longDesc:
        "Develop and execute content strategies that attract, engage, and convert your target audience through blog posts, videos, infographics, whitepapers, and other content formats.",
      features: [
