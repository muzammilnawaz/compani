...
function MenubarMenu({ ...props }) {
  return /*#__PURE__*/ React.createElement(
    ...
    _extends({ "data-slot": "menubar-menu" }, props)
  );
}
...
function MenubarGroup({ ...props }) {
  return /*#__PURE__*/ React.createElement(
    ...
    _extends({ "data-slot": "menubar-group" }, props)
  );
}
...
function MenubarPortal({ ...props }) {
  return /*#__PURE__*/ React.createElement(
    ...
    _extends({ "data-slot": "menubar-portal" }, props)
  );
}
...
function MenubarRadioGroup({ ...props }) {
  return /*#__PURE__*/ React.createElement(
    ...
    _extends({ "data-slot": "menubar-radio-group" }, props)
  );
}
    ...
    _extends(
      {
        ...
        className: cn(
          "focus:bg-accent focus:text-accent-foreground " +
            "relative flex cursor-default items-center gap-2 rounded-xs " +
...
function MenubarSub({ ...props }) {
  return /*#__PURE__*/ React.createElement(
    ...
    _extends({ "data-slot": "menubar-sub" }, props)
  );
}
